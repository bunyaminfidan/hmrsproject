...
public class BaseIndividualUserManager extends UserManager implements BaseIndividualUserService {
	...
	public Result add(BaseIndividualUser baseIndividualUser, String passwordAgain) {
		...
		if (!BaseIndividualValidator
				.checkValuesIndividualUser(baseIndividualUser.getFirstName(), baseIndividualUser.getLastName(),
						baseIndividualUser.getNationalityId(), baseIndividualUser.getDateOfBirth())
				.isSuccess())
			return new ErrorResult(BaseIndividualValidator
					.checkValuesIndividualUser(baseIndividualUser.getFirstName(), baseIndividualUser.getLastName(),
							baseIndividualUser.getNationalityId(), baseIndividualUser.getDateOfBirth())
					.getMessage());
